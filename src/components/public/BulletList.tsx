          ...
          <li key={key} className="relative">
            ...
            {isLink ? (
              <a
                ...
                className="flex items-center justify-between gap-2 rounded-xl border border-white/7 bg-white/6 py-3 pr-3.5 pl-7 text-[11.5px] leading-snug tracking-[0.02em] text-white/88 transition-colors hover:border-glam-500/30 hover:bg-white/9 hover:text-white sm:text-sm"
              >
                {label}
